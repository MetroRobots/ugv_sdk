...
int main(int argc, char** argv)
{
  ...
  {
    std::cout << "Usage: app_hunter_demo <interface>" << std::endl << "Example 1: ./app_hunter_demo can0" << std::endl;
    return -1;
  }
  ...
  {
    hunter = std::unique_ptr<HunterRobot>(new HunterRobot(ProtocolVersion::AGX_V1));
  }
  else if (proto == ProtocolVersion::AGX_V2)
  {
    hunter = std::unique_ptr<HunterRobot>(new HunterRobot(ProtocolVersion::AGX_V2));
  }
  else
  {
