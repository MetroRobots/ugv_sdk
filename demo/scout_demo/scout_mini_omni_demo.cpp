...
int main(int argc, char** argv)
{
  ...
  if (proto == ProtocolVersion::AGX_V1)
  {
    ...
    scout = std::unique_ptr<ScoutMiniOmniRobot>(new ScoutMiniOmniRobot(ProtocolVersion::AGX_V1));
  }
  else if (proto == ProtocolVersion::AGX_V2)
  {
    std::cout << "Detected protocol: AGX_V2" << std::endl;
    scout = std::unique_ptr<ScoutMiniOmniRobot>(new ScoutMiniOmniRobot(ProtocolVersion::AGX_V2));
  }
  else
  {
  ...
  while (true)
  {
    ...
    std::cout << "velocity (linear, angular, lateral): " << state.motion_state.linear_velocity << ", "
              << state.motion_state.angular_velocity << ", " << state.motion_state.lateral_velocity << std::endl;
