...
public:
  ...
  void SetLightCommand(LightMode f_mode, uint8_t f_value, LightMode r_mode = LightMode::CONST_ON,
...
template <typename ParserType>
class ScoutMiniOmniBase : public ScoutBase<ParserType>, public ScoutOmniInterface
{
public:
  void SetMotionCommand(double linear_vel, double angular_vel, double lateral_velocity) override
  {
    AgilexBase<ParserType>::SendMotionCommand(linear_vel, angular_vel, lateral_velocity, 0.0);
  }
