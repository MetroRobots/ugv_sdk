...
public:
  ...
  bool EncodeMessage(const AgxMessage* msg, struct can_frame* tx_frame) override
  {
    ...
    if (msg->type == AgxMsgMotionCommandV1)
    {
      ...
      msg_v1.body.v1_motion_command_msg.linear = linear / RobotLimitsType::max_linear * 100.0;
      msg_v1.body.v1_motion_command_msg.angular = angular / RobotLimitsType::max_angular * 100.0;
      msg_v1.body.v1_motion_command_msg.lateral = lateral / RobotLimitsType::max_lateral * 100.0;
    }
  ...
  void EncodeMessage(const AgxMessage* msg, uint8_t* buf, uint8_t* len) override
  {
  }
