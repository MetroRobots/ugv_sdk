...
bool DecodeCanFrameV2(const struct can_frame* rx_frame, AgxMessage* msg)
{
  ...
  case CAN_MSG_MOTION_COMMAND_ID:
  {
    ...
    msg->body.motion_command_msg.linear_velocity =
        (int16_t)((uint16_t)(frame->linear_velocity.low_byte) | (uint16_t)(frame->linear_velocity.high_byte) << 8) /
        1000.0;
    msg->body.motion_command_msg.angular_velocity =
        (int16_t)((uint16_t)(frame->angular_velocity.low_byte) | (uint16_t)(frame->angular_velocity.high_byte) << 8) /
        1000.0;
    msg->body.motion_command_msg.lateral_velocity =
        (int16_t)((uint16_t)(frame->lateral_velocity.low_byte) | (uint16_t)(frame->lateral_velocity.high_byte) << 8) /
        1000.0;
    msg->body.motion_command_msg.steering_angle =
        (int16_t)((uint16_t)(frame->steering_angle.low_byte) | (uint16_t)(frame->steering_angle.high_byte) << 8) /
        1000.0;
    break;
  }
  case CAN_MSG_LIGHT_COMMAND_ID:
  {
    ...
    msg->body.light_command_msg.enable_cmd_ctrl = (frame->enable_cmd_ctrl != 0) ? true : false;
    msg->body.light_command_msg.front_light.mode = frame->front_mode;
    msg->body.light_command_msg.front_light.custom_value = frame->front_custom;
  ...
  case CAN_MSG_SYSTEM_STATE_ID:
  {
    ...
    msg->body.system_state_msg.battery_voltage =
        (int16_t)((uint16_t)(frame->battery_voltage.low_byte) | (uint16_t)(frame->battery_voltage.high_byte) << 8) *
        0.1;
    msg->body.system_state_msg.error_code =
        (uint16_t)(frame->error_code.low_byte) | (uint16_t)(frame->error_code.high_byte) << 8;
    break;
  }
  ...
  case CAN_MSG_ACTUATOR8_HS_STATE_ID:
  {
    ...
    msg->body.actuator_hs_state_msg.motor_id = rx_frame->can_id - CAN_MSG_ACTUATOR1_HS_STATE_ID;
    msg->body.actuator_hs_state_msg.rpm =
        (int16_t)((uint16_t)(frame->rpm.low_byte) | (uint16_t)(frame->rpm.high_byte) << 8);
    msg->body.actuator_hs_state_msg.current =
        ((uint16_t)(frame->current.low_byte) | (uint16_t)(frame->current.high_byte) << 8) * 0.1;
    msg->body.actuator_hs_state_msg.pulse_count =
        (int32_t)((uint32_t)(frame->pulse_count.lsb) | (uint32_t)(frame->pulse_count.low_byte) << 8 |
                  (uint32_t)(frame->pulse_count.high_byte) << 16 | (uint32_t)(frame->pulse_count.msb) << 24);
    break;
  }
  ...
  case CAN_MSG_ACTUATOR8_LS_STATE_ID:
  {
    ...
    msg->body.actuator_hs_state_msg.motor_id = rx_frame->can_id - CAN_MSG_ACTUATOR1_LS_STATE_ID;
    msg->body.actuator_ls_state_msg.driver_voltage =
        ((uint16_t)(frame->driver_voltage.low_byte) | (uint16_t)(frame->driver_voltage.high_byte) << 8) * 0.1;
    msg->body.actuator_ls_state_msg.driver_temp =
        (int16_t)((uint16_t)(frame->driver_temp.low_byte) | (uint16_t)(frame->driver_temp.high_byte) << 8);
  ...
  case CAN_MSG_ODOMETRY_ID:
  {
    ...
    msg->body.odometry_msg.left_wheel =
        (int32_t)((uint32_t)(frame->left_wheel.lsb) | (uint32_t)(frame->left_wheel.low_byte) << 8 |
                  (uint32_t)(frame->left_wheel.high_byte) << 16 | (uint32_t)(frame->left_wheel.msb) << 24);
    msg->body.odometry_msg.right_wheel =
        (int32_t)((uint32_t)(frame->right_wheel.lsb) | (uint32_t)(frame->right_wheel.low_byte) << 8 |
                  (uint32_t)(frame->right_wheel.high_byte) << 16 | (uint32_t)(frame->right_wheel.msb) << 24);
    break;
  }
  ...
  case CAN_MSG_BMS_BASIC_ID:
  {
    ...
    msg->body.bms_basic_msg.voltage =
        (int16_t)((uint16_t)(frame->voltage.low_byte) | (uint16_t)(frame->voltage.high_byte) << 8) * 0.1;
    msg->body.bms_basic_msg.current =
        (int16_t)((uint16_t)(frame->current.low_byte) | (uint16_t)(frame->current.high_byte) << 8) * 0.1;
    msg->body.bms_basic_msg.temperature =
        (int16_t)((uint16_t)(frame->temperature.low_byte) | (uint16_t)(frame->temperature.high_byte) << 8) * 0.1;
    break;
  }
  ...
  case CAN_MSG_CTRL_MODE_CONFIG_ID:
  {
    ...
    ControlModeConfigFrame* frame = (ControlModeConfigFrame*)(rx_frame->data);
  ...
  case CAN_MSG_STATE_RESET_CONFIG_ID:
  {
    ...
    msg->body.state_reset_config_msg.error_clear_byte = frame->error_clear_byte;
    break;
  }
  case CAN_MSG_MOTOR_ANGLE_INFO:
  {
    ...
    msg->body.motor_angle_msg.angle_5 =
        (int16_t)((uint16_t)(frame->angle_5.low_byte) | (uint16_t)(frame->angle_5.high_byte) << 8) * 0.01;
    msg->body.motor_angle_msg.angle_6 =
        (int16_t)((uint16_t)(frame->angle_6.low_byte) | (uint16_t)(frame->angle_6.high_byte) << 8) * 0.01;
    msg->body.motor_angle_msg.angle_7 =
        (int16_t)((uint16_t)(frame->angle_7.low_byte) | (uint16_t)(frame->angle_7.high_byte) << 8) * 0.01;
    msg->body.motor_angle_msg.angle_8 =
        (int16_t)((uint16_t)(frame->angle_8.low_byte) | (uint16_t)(frame->angle_8.high_byte) << 8) * 0.01;
    break;
  }
  case CAN_MSG_MOTOR_SPEED_INFO:
  {
    ...
    msg->body.motor_speed_msg.speed_1 =
        (int16_t)((uint16_t)(frame->speed_1.low_byte) | (uint16_t)(frame->speed_1.high_byte) << 8) * 0.001;
    msg->body.motor_speed_msg.speed_2 =
        (int16_t)((uint16_t)(frame->speed_2.low_byte) | (uint16_t)(frame->speed_2.high_byte) << 8) * 0.001;
    msg->body.motor_speed_msg.speed_3 =
        (int16_t)((uint16_t)(frame->speed_3.low_byte) | (uint16_t)(frame->speed_3.high_byte) << 8) * 0.001;
    msg->body.motor_speed_msg.speed_4 =
        (int16_t)((uint16_t)(frame->speed_4.low_byte) | (uint16_t)(frame->speed_4.high_byte) << 8) * 0.001;
    break;
  }
  default:
    break;
...
bool EncodeCanFrameV2(const AgxMessage* msg, struct can_frame* tx_frame)
{
  ...
  case AgxMsgMotionCommand:
  {
    ...
    int16_t lateral_cmd = (int16_t)(msg->body.motion_command_msg.lateral_velocity * 1000);
    int16_t steering_cmd = (int16_t)(msg->body.motion_command_msg.steering_angle * 1000);
  ...
  case AgxMsgLightCommand:
  {
    ...
    if (msg->body.light_command_msg.enable_cmd_ctrl)
    {
      ...
      frame.front_custom = msg->body.light_command_msg.front_light.custom_value;
  ...
  case AgxMsgSystemState:
  {
    ...
    uint16_t battery = (uint16_t)(msg->body.system_state_msg.battery_voltage * 10);
    frame.battery_voltage.high_byte = (uint8_t)(battery >> 8);
    frame.battery_voltage.low_byte = (uint8_t)(battery & 0x00ff);
    frame.error_code.high_byte = (uint8_t)(msg->body.system_state_msg.error_code >> 8);
    frame.error_code.low_byte = (uint8_t)(msg->body.system_state_msg.error_code & 0x00ff);
    memcpy(tx_frame->data, (uint8_t*)(&frame), tx_frame->can_dlc);
    break;
  }
  case AgxMsgMotionState:
  {
    ...
    int16_t linear = (int16_t)(msg->body.motion_state_msg.linear_velocity * 1000);
    int16_t angular = (int16_t)(msg->body.motion_state_msg.angular_velocity * 1000);
    int16_t lateral = (int16_t)(msg->body.motion_state_msg.lateral_velocity * 1000);
    int16_t steering = (int16_t)(msg->body.motion_state_msg.steering_angle * 1000);
  ...
  {
    tx_frame->can_id = msg->body.actuator_hs_state_msg.motor_id + CAN_MSG_ACTUATOR1_HS_STATE_ID;
    tx_frame->can_dlc = 8;
  ...
  {
    tx_frame->can_id = msg->body.actuator_ls_state_msg.motor_id + CAN_MSG_ACTUATOR1_LS_STATE_ID;
    tx_frame->can_dlc = 8;
  ...
  {
    tx_frame->can_id = msg->body.ultrasonic_msg.sensor_id + CAN_MSG_ULTRASONIC_1_ID;
    tx_frame->can_dlc = 8;
